                ...
                <Container maxWidth="md">
                    <Paper elevation={0} sx={{ p: 0 }}>
                        ...
                        <Box sx={{ typography: 'body1', color: '#333', lineHeight: 1.7 }}>
                            ...
                            <p>
                                You agree that if you have any question or complaint with regard to any product and/or service availed on our Platform, or pertaining to the Transaction, including but not limited to, double debit of Transaction Amount, fraudulent Transaction, unauthorized Transaction, refund requests, etc., you may reach out to us at <strong>contactbichat@gmail.com</strong>.
                            </p>
